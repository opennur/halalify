...
| `res/values/strings.xml` | Canonical English string resources, including the content-protection settings and control-center labels. All feature modules inherit this via the module dependency; they only declare strings unique to their feature. |
